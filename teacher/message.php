        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li style="margin-top: 15px"><img class="img-circle" style="width:35px;height: 35px; margin-top: -9px;" src="../home/tea_img/<?=$_SESSION['activeUser']['user_photo'];?>"> <?=$_SESSION['user_login'];?> </li>
...
if(isset($_POST['submit'])){
   ...
   $msg =  mysqli_real_escape_string($link,$_POST['chat']);
    $query = "INSERT INTO `message`(`user_id`,`username`, `faculty`, `messages`, `status`, `sender`) VALUES ('$user_id','$_SESSION[user_login]','$faculty','$msg','no','teacher')";
 ...
 ?>
    <div class="wrapper">
        <!-- <div style="height: 70px; width: 100%;background-color:#2eac8b;text-align: center;color: white">
            <h3 style="margin-top: -5px; padding-top: 5px;padding-top: 10px;">Admin</h3>
        </div> -->
        <div class="msg">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if($row['sender'] == 'teacher'){
             ?>
            <!-- ............................For student....... -->
           
            <br><div class="chat student">
        ...
        <?php
         ...
         ?>
                ...
                <!-- ............................For Admin........................... -->
              <br><div class="chat teacher">
                <div style="float:left; padding-top: 5px;">
                    &nbsp
                 <img class="img-circle" style="height: 40px; width:35px" src="../home/<?php echo $imgDir . '/' . $MessageUser['photo'] ?>" alt="..."> 
                    &nbsp
                </div>
                <div style="float: left;" class="chatbox">
              <?=$row['messages'];?>
