    ...
    if (!isset($_SESSION['validation']))
    {
        ...
        if ($file_size <5000000)
        {
            if (in_array($file_ext, $permitted))
            {
                ...
                $query = "INSERT INTO `file`(`name`, `roll`, `contract`, `sub_code`, `faculty`, `file`) VALUES ('$name', '$roll', '$contrct','$code','$feculty','$file')";
...
<body>
    ...
    <table class="countdownContainer" id="tabless">
    <tr class="header">
      <td colspan="4" id="showDays"></td>
    </tr>
    <tr class="info">
      <td id="days"></td>
      <td id="hours"></td>
  ...
  <div id="expermsg" class="alert alert-danger" style="margin-left:450px; margin-top: 10px; text-align: center; width: 50%; display: none;"> 
    <h5>Sorry Date is over U can contract With your Faculty!</h5>
  </div>
    <div class="container" id="exper">
        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-4">
                <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="roll" class="control-label col-sm-1">Enter Id</label>
                        <div class="col-sm-4">
                            <input class="form-control" id="roll" type="text" name="roll" placeholder="1734****"/>
                        </div>
                        <label class="error">
                            <?php
...
<script>
  function countDown(){
      ...
      var now = new Date();
      var eventDate = new Date("April 7, 2020 18:18:25");
    ...
    document.getElementById("showDays").innerText = "Only" + d +"days left!";

   

    if(d == 1){

    document.getElementById("showDays").style.color = 'red';
    ...
    if(d <= 0 && h <= 0 && m <= 0 && s <= 0 ){
        ...
        document.getElementById("expermsg").style.display ='block';
