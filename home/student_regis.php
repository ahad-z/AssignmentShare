...
if (empty($name))
       ...
       if(!isset($_SESSION['validation'])) 
    {
        ...
        $email_check = mysqli_query($link, "SELECT * FROM `student` WHERE `email` = '$email'");
                ...
                if (strlen($username) > 7)
                {
                    ...
                    if (strlen($password) > 7)
                    {
                        ...
                        if ($password == $c_password)
                        {
                            ...
                            $query = "INSERT INTO `student`( `name`, `username`, `faculty`, `email`, `password`, `photo`, `status`) VALUES('$name','$username','$faculty','$email','$password','$photo_name','inactive')";
                            $result = mysqli_query($link, $query);

                            if ($result)
                            {

                                move_uploaded_file($_FILES['photo']['tmp_name'], 'stu_img/' . $photo_name);
                          ...
                          header('Location:student_regis.php');
                            exit();
...
<head>
    ...
    <body>
        ...
        <div class="container">
            <h1 class="col-md-offset-2">Student Registration Form!</h1>
            <?php 
